...
public class SimpleLoadManagerImpl implements LoadManager, Consumer<Notification> {
    ...
    public void writeLoadReportOnZookeeper() throws Exception {
        ...
        int minInterval = pulsar.getConfiguration().getLoadBalancerReportUpdateMinIntervalMilliSeconds();
        if (this.avgJvmHeapUsageMBytes <= 0) {
    ...
    private boolean isLoadReportGenerationIntervalPassed() {
        ...
        return timeSinceLastGenMillis > pulsar.getConfiguration().getLoadBalancerReportUpdateMinIntervalMilliSeconds();
    }
